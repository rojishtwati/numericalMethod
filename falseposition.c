/*
Program for fasleposition method
Author :-ROJISH TWATI
...
void display(){
    ...
    printf(" |iteration  |\tx1\t|\tx2\t|\tx3\t|\tfx1\t|\tfx2\t|\tfx3     |\n");
  //  printf("  -----------|----------|---------------|---------------|---------------|---------------|---------------|\n");
    while(fx[3]>error){
        iteration++;
        x[3]=x[1]-((fx[1]*(x[2]-x[1]))/(fx[2]-fx[1]));
        fx[3]=equation(x[3]);
        printf(" |-----------|----------|---------------|---------------|---------------|---------------|---------------|\n");
     ...
     printf(" |___________|__________|_______________|_______________|_______________|_______________|_______________|\n");
